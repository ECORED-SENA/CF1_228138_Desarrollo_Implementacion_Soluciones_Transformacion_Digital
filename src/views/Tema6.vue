        ...
        .col-lg-8.col-12
          ...
          ul.lista-ul--color.mb-lg-0.mb-3
            li.mb-2
              ...
              span Acceso abusivo a un sistema informático (modificado del Código Penal).
            li.mb-2
              i.fas.fa-check(style="color:#083142")
              span Obstaculización ilegítima del sistema informático o red de telecomunicación.
            li.mb-2
              i.fas.fa-check(style="color:#083142")
              span Interceptación de datos informáticos.
            li.mb-2
              i.fas.fa-check(style="color:#083142")
              span Daño informático; uso de <em>software </em>malicioso.
            li.mb-2
              i.fas.fa-check(style="color:#083142")
              span Hurto por medios informáticos y semejantes.
            li.mb-2
              i.fas.fa-check(style="color:#083142")
              span Violación de datos personales.
            li.mb-2
              i.fas.fa-check(style="color:#083142")
              span Suplantación de sitios <em><em>web</em> </em> para capturar datos personales y transferencia no consentida de activos.
