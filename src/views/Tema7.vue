<template lang="pug">
  .curso-main-container.pb-3.tema7
    ...
    .container.tarjeta.tarjeta--blanca.p-4.p-md-5
      ...
      p.mb-5 Los activos de información relacionados con la seguridad de la información, hacen referencia a cualquier información o dispositivo que tenga que ver con el tratamiento de esta y que sea de valor para la organización.
      ...
      .row.justify-content-center.align-items-center.mb-5(data-aos="fade-right")
        .col-lg-10.col-12
          .bloque-texto-g.color-secundario.p-lg-5.p-2
            .bloque-texto-g__img(
              :style="{'background-image': `url(${require('@/assets/curso/tema7/img12.png')})`}"
            )
