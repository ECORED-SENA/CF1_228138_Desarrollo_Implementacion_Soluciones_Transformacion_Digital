...
.curso-main-container.pb-3.tema8
  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .tarjeta.tarjeta--azul.p-4.mb-0(style="background-color:#fff3ea")
      SlyderA(tipo="b")
              ...
              .col-lg-8.col-12.d-block
                .d-block
                  ...
                  ul.lista-ul--color.d-block
                    li
                      i.fas.fa-check
                      span Fallas de configuración
                    li
                      i.fas.fa-check
                      span Fallas en la gestión de recursos
                    li
                      i.fas.fa-check
                      span Fallas en los sistemas de validación
                    li
                      i.fas.fa-check
                      span Errores que generan el acceso a directorios
                    li
                      i.fas.fa-check
                      span Errores en la gestión y asignación de permisos
              .col-lg-4.col-8.px-5
