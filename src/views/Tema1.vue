      ...
      .row.justify-content-center.align-items-center.mb-4(data-aos="fade-right")
        ...
        .col-lg-7.col-12
          ...
          .cajon.color-secundario.p-4.mb-4
            p.mb-0 Los protocolos TCP/IP son un conjunto de reglas para formatos de mensajes y procedimientos, que permiten que el <em>hardware</em> y los <em>software</em> de aplicación, intercambien información.
